...
export default function WhyTrend() {
  ...
  return (
    <section
      id="why-trend"
      className="relative overflow-hidden bg-gradient-to-br from-[#16051f] via-[#3b0a63] to-[#08010f] py-20 text-white max-md:py-14"
    >
      <div
        className="pointer-events-none absolute -start-24 top-16 h-80 w-80 animate-glow-drift rounded-full bg-purple-600/25 blur-3xl"
        aria-hidden="true"
      />
      <div
        className="pointer-events-none absolute -end-20 bottom-10 h-96 w-96 animate-glow-drift-reverse rounded-full bg-fuchsia-500/15 blur-3xl [animation-delay:2s]"
        aria-hidden="true"
      />
      <div
        ...
        <div className="relative mx-auto max-w-[1100px] md:min-h-[500px] lg:min-h-[580px]">
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-white/20 shadow-[0_24px_80px_rgba(124,58,237,0.45)]">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#16051f]/80 via-transparent to-transparent" />
