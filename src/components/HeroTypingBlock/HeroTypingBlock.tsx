  ...
  return (
    <>
      ...
      <div className="max-w-[680px] text-center lg:text-start">
        <div className="mb-6">
          <p className="mb-2 text-[clamp(16px,2.5vw,20px)] text-white/75">
            {t('hero.typingPrefix')}
          </p>
          <p className="min-h-[1.3em] text-[clamp(32px,5vw,56px)] font-bold leading-tight text-purple-300">
            {displayText}
            <span
        ...
        <h1 className="mb-9 text-[clamp(28px,4.5vw,52px)] font-extrabold leading-tight tracking-tight text-white drop-shadow-[0_2px_20px_rgba(0,0,0,0.3)]">
          {t('hero.headline')}
        </h1>

        <div className="flex flex-wrap justify-center gap-3.5 lg:justify-start max-sm:flex-col max-sm:items-stretch">
