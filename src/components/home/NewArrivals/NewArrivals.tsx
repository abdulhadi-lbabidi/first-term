...
import LoadingState from '../../common/UiStates/LoadingState'
import ErrorState from '../../common/UiStates/ErrorState'
  ...
  return (
    <section className="relative overflow-hidden bg-white py-20 max-md:py-14">
      ...
      <div className="container relative">
        ...
        {!loading && !error && (
          <div className="grid grid-cols-1 gap-7 md:grid-cols-2 md:items-stretch md:gap-6 lg:grid-cols-3 lg:gap-8">
