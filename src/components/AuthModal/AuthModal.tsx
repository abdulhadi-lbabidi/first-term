...
function getPanelClass(isActive: boolean, direction: 'register' | 'login') {
  if (isActive) {
    return 'pointer-events-auto translate-x-0 translate-y-0 opacity-100'
  }

  if (direction === 'register') {
    return 'pointer-events-none -translate-x-4 -translate-y-1 opacity-0 rtl:translate-x-4'
  }

  return 'pointer-events-none translate-x-4 translate-y-2 opacity-0 rtl:-translate-x-4'
}
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-[960px] overflow-hidden rounded-3xl bg-white/90 shadow-2xl backdrop-blur-xl">
        ...
        <div className="flex h-[560px] max-h-[90vh] flex-col lg:h-[520px] lg:max-h-[520px] lg:flex-row lg:rtl:flex-row-reverse">
          ...
          <div className="relative flex h-full w-full flex-1 flex-col bg-white/95 p-6 backdrop-blur-xl sm:p-8">
            <div
            ...
            <div className="relative z-10 h-[440px] shrink-0 overflow-hidden">
              ...
              <div
                className={`absolute inset-0 flex flex-col ${panelTransition} ${getPanelClass(mode === 'register', 'register')}`}
              ...
              >
                ...
                <form onSubmit={handleRegisterSubmit} className="flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto pe-1">
                  <div>
              ...
              <div
                className={`absolute inset-0 flex flex-col ${panelTransition} ${getPanelClass(mode === 'login', 'login')}`}
