...
export default function Offers() {
  ...
  return (
    <section
      id="offers"
      className="relative overflow-hidden bg-gradient-to-br from-[#12021c] via-[#2d0a4a] to-[#0a0112] py-20 text-white max-md:py-14"
    >
      <div
        ...
        <div className="relative mx-auto max-w-[1140px]">
          <div className="flex flex-col gap-8 lg:grid lg:grid-cols-3 lg:items-end lg:gap-7">
            {offerPosters.map((poster, index) => (
              <OfferPoster key={poster.id} poster={poster} index={index} />
            ))}
          </div>
        </div>
      </div>
