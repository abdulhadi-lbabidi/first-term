...
export default function OfferPoster({ poster, index }: OfferPosterProps) {
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-x-0 bottom-0 z-10 max-h-[45%]">
          <div className="flex h-full flex-col justify-end bg-gradient-to-t from-black/95 via-[#16051f]/88 to-transparent px-6 pb-6 pt-10 max-md:px-5 max-md:pb-5 max-md:pt-8">
            ...
            <div className="mt-4 flex flex-wrap items-center gap-3">
              ...
              <a href={poster.href} className={buttonClasses}>
